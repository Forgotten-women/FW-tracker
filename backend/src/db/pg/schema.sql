...
CREATE INDEX IF NOT EXISTS idx_mac_binding_employee ON device_mac_bindings (employee_id);
CREATE UNIQUE INDEX IF NOT EXISTS idx_mac_binding_active ON device_mac_bindings (mac_hash);
...
CREATE INDEX IF NOT EXISTS idx_employment_current ON employment_records (employee_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_accrual_unique_month ON leave_accrual_ledger (employee_id, leave_year, effective_date);
...
CREATE INDEX IF NOT EXISTS idx_salary_current ON salary_history (employee_id);
