...
/**
 * Inline outline icons (24x24 grid, 2px stroke, round caps/joins) used in
 * place of emoji so glyphs follow the surrounding text colour and theme.
 * No icon library is installed on purpose — add new icons here as needed.
 * `className` replaces the default size, so always pass a size with it.
 */
...
export function PalmTreeIcon({ className }: IconProps) {
  return (
    <Icon className={className}>
